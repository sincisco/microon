package com.zijin.microon.ueditor;
...
import com.zijin.microon.ueditor.define.ActionMap;
import com.zijin.microon.ueditor.define.BaseState;
import com.zijin.microon.ueditor.define.State;
import com.zijin.microon.ueditor.hunter.FileManager;
import com.zijin.microon.ueditor.hunter.ImageHunter;
import com.zijin.microon.ueditor.upload.Uploader;

public class ActionEnter {

	private static Log log=LogFactory.getLog(ActionEnter.class);
	...
	public ActionEnter(HttpServletRequest request, String rootPath) {
		...
		log.info(this.actionType+" "+this.contextPath);
		log.info(rootPath);
	}
