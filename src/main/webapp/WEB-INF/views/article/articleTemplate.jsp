...
<link
	href="http://localhost:8080/microon/ueditor/themes/default/dialogbase.css?cache=0.22594237422854035"
...
<script type="text/javascript"
	...
	id="syntaxhighlighter_js"></script>
<style type="text/css">
.view {
	padding: 0;
...
table.sortEnabled tr.firstRow th, table.sortEnabled tr.firstRow td {
	...
	background-image:
		url(http://localhost:8080/microon/ueditor/themes/default/images/sortable.png);
}
</style>
<style id="table">
.selectTdClass {
...
.loadingclass {
	...
	cursor: default;
	background:
		url('http://localhost:8080/microon/ueditor/themes/default/images/loading.gif')
...
.loaderrorclass {
	...
	cursor: default;
	background:
		url('http://localhost:8080/microon/ueditor/themes/default/images/loaderror.png')
		no-repeat center center transparent;
	border: 1px solid #cccccc;
	margin-right: 1px;
	height: 22px;
...
.anchorclass {
	background:
		url('http://localhost:8080/microon/ueditor/themes/default/images/anchor.gif')
...
<body>
		...
		<div id="secondary" class="secondary">
			<div id="widget-area" class="widget-area" role="complementary">
				<aside id="categories-4" class="widget widget_categories">
					...
					<ul>
						<li class="cat-item cat-item-4"><a href="#" title="学海无涯">学习</a>
							<ul class="children">
								<li class="cat-item cat-item-106"><a href="#">管理旁通</a></li>
								<li class="cat-item cat-item-132"><a href="#" title="">读书</a></li>
								<li class="cat-item cat-item-27"><a href="#" title="">java基础</a></li>
							</ul></li>
						<li class="cat-item cat-item-5"><a href="#">前端新架构</a>
							<ul class="children">
								<c:forEach var="articleItem" items="${articleList}">
									<li class="cat-item cat-item-255"><a
										title="${articleItem.title}" href="${articleItem.id}.do">${articleItem.title}</a></li>
								</c:forEach>
							</ul></li>
						<li class="cat-item cat-item-5"><a href="#">牧羊犬</a>
							<ul class="children">
								<c:forEach var="articleItem" items="${articleList}">
									<li class="cat-item cat-item-255"><a
										title="${articleItem.title}" href="${articleItem.id}.do">${articleItem.title}</a></li>
						...
						<li class="cat-item cat-item-6"><a href="#" title="随便记点什么">杂文</a>
							<ul class="children">
								<li class="cat-item cat-item-255"><a href="#" title="">XXX</a></li>
								<li class="cat-item cat-item-404"><a href="#" title="">见闻</a></li>
							</ul></li>
	...
	<article style="margin-left: 21%; padding: 5%">
		<h1>${article.title} <a href="../editArticle/${article.id}.do">[修改]</a></h1>
		<p>
		${article.outline}
		</p>
		${article.content}
